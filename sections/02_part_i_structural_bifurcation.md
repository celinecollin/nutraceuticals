...
Part I establishes the report's underwriting perimeter: what qualifies as investable nutraceutical exposure, which evidence thresholds sustain pricing power, and where regulatory design creates durable entry barriers. This section translates the executive thesis into operating rules that can be stress-tested in due diligence.

## I.1. Regulatory Fragmentation Creates Defensible Moats

**Regulatory pathway selection is a first-order value driver, not a compliance afterthought.**
...
**Policy shocks have converted functional additives from optional enhancement to operational necessity in production systems.**
